...
var Ne = ({
  ...
  ), N = (0, import_react.useMemo)(() => m === "srcDoc" ? _e(a ?? "", "allow-scripts") : _e(a ?? "", "allow-scripts allow-same-origin"), [a, m]);
  ...
  }, [e, E, m, d, _]), f ? (0, import_jsx_runtime.jsx)("p", { className: "text-red-500", children: f }) : m === "srcDoc" ? d == null ? f ? null : (0, import_jsx_runtime.jsx)("p", { className: "text-orange-500", children: "No HTML content to display." }) : (0, import_jsx_runtime.jsx)(
    "iframe",
    {
      srcDoc: d,
      sandbox: N,
