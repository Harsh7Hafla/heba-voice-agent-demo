  ...
  m3.forEach(function(e3) {
    e3 && typeof e3 !== "string" && !Array.isArray(e3) && Object.keys(e3).forEach(function(k2) {
      if (k2 !== "default" && !(k2 in n2)) {
        ...
        Object.defineProperty(n2, k2, d3.get ? d3 : { enumerable: true, get: function() {
          return e3[k2];
        } });
      }
    });
...
var h = (i2, s3, t) => s3 in i2 ? e(i2, s3, {
  enumerable: true,
  configurable: true,
  writable: true,
  value: t
}) : i2[s3] = t;
var o = (i2, s3, t) => h(i2, typeof s3 != "symbol" ? s3 + "" : s3, t);
var _ = class {
  constructor() {
    o(this, "_locking");
    o(this, "_locks");
  ...
  lock() {
    this._locks += 1;
    let s3;
    const t = new Promise((l2) => s3 = () => {
      this._locks -= 1, l2();
    }), c3 = this._locking.then(() => s3);
    return this._locking = this._locking.then(() => t), c3;
  }
};
  ...
  return {
    ...
    writeMessage(message, options) {
      ...
      try {
        ...
        const r4 = e3 instanceof Error ? e3.message : String(e3);
  ...
  return {
    ...
    initPartial(source, target) {
      ...
      for (const member of type.fields.byMember()) {
        const localName = member.localName, t = target, s3 = source;
        ...
        switch (member.kind) {
              ...
              case "enum":
                if (member.V.T === ScalarType.BYTES) {
                  for (const [k2, v3] of Object.entries(s3[localName])) {
                    t[localName][k2] = toU8Arr(v3);
                  }
                } else {
                  Object.assign(t[localName], s3[localName]);
                }
                break;
              case "message":
          ...
          case "message":
            const mt = member.T;
            if (member.repeated) {
              t[localName] = s3[localName].map((val2) => isMessage(val2, mt) ? val2 : new mt(val2));
            } else {
    ...
    equals(type, a2, b2) {
      ...
      return type.fields.byMember().every((m3) => {
        const va = a2[m3.localName];
        const vb = b2[m3.localName];
        if (m3.repeated) {
          ...
          switch (m3.kind) {
            case "message":
              return va.every((a3, i2) => m3.T.equals(a3, vb[i2]));
            case "scalar":
              return va.every((a3, i2) => scalarEquals(m3.T, a3, vb[i2]));
            case "enum":
          ...
          case "message":
            ...
            if (m3.T.fieldWrapper) {
              if (a3 !== void 0 && !isMessage(a3)) {
                a3 = m3.T.fieldWrapper.wrapField(a3);
              }
              if (b3 !== void 0 && !isMessage(b3)) {
                b3 = m3.T.fieldWrapper.wrapField(b3);
              }
            }
            return m3.T.equals(a3, b3);
          case "enum":
            return scalarEquals(ScalarType.INT32, va, vb);
          case "scalar":
            return scalarEquals(m3.T, va, vb);
          case "oneof":
            if (va.case !== vb.case) {
              return false;
            }
            const s3 = m3.findField(va.case);
            if (s3 === void 0) {
              return true;
            }
            switch (s3.kind) {
...
function shimGetUserMedia$2(window2, browserDetails2) {
    ...
    Object.keys(c3).forEach((key) => {
      ...
      if (r4.ideal !== void 0) {
        ...
        if (typeof r4.ideal === "number") {
          oc[oldname_("min", key)] = r4.ideal;
          cc.optional.push(oc);
          oc = {};
          oc[oldname_("max", key)] = r4.ideal;
          cc.optional.push(oc);
        } else {
          oc[oldname_("", key)] = r4.ideal;
          cc.optional.push(oc);
        }
      }
      if (r4.exact !== void 0 && typeof r4.exact !== "number") {
        cc.mandatory = cc.mandatory || {};
        cc.mandatory[oldname_("", key)] = r4.exact;
      } else {
        ["min", "max"].forEach((mix) => {
          if (r4[mix] !== void 0) {
            cc.mandatory = cc.mandatory || {};
            cc.mandatory[oldname_(mix, key)] = r4[mix];
          }
        });
      }
    });
  ...
  const getUserMedia_ = function(constraints, onSuccess, onError) {
    shimConstraints_(constraints, (c3) => {
      navigator2.webkitGetUserMedia(c3, onSuccess, (e3) => {
        if (onError) {
        ...
        this._ontrackpoly = (e3) => {
          e3.stream.addEventListener("addtrack", (te) => {
            ...
            if (window2.RTCPeerConnection.prototype.getReceivers) {
              receiver = this.getReceivers().find((r4) => r4.track && r4.track.id === te.track.id);
            } else {
              receiver = {
                track: te.track
              };
          ...
          e3.stream.getTracks().forEach((track) => {
            let receiver;
            if (window2.RTCPeerConnection.prototype.getReceivers) {
              receiver = this.getReceivers().find((r4) => r4.track && r4.track.id === track.id);
            } else {
              receiver = {
                track
              };
  ...
  handleConnectionError(reason, validateUrl) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        return e3 instanceof ConnectionError ? e3 : ConnectionError.serverUnreachable(e3 instanceof Error ? e3.message : "server was not reachable");
      }
    });
  }
};
...
function r(r4, e3, n2) {
  ...
  var a2 = null != (i2 = n2.isImmediate) && i2, u3 = null != (t = n2.callback) && t, c3 = n2.maxWait, v3 = Date.now(), l2 = [];
  function f2() {
    if (void 0 !== c3) {
      var r5 = Date.now() - v3;
      if (r5 + e3 >= c3) return c3 - r5;
    }
    return e3;
  }
  var d3 = function() {
    ...
    return new Promise(function(i3, t2) {
      ...
      if (void 0 !== o3 && clearTimeout(o3), o3 = setTimeout(function() {
        if (o3 = void 0, v3 = Date.now(), !a2) {
          var i4 = r4.apply(n3, e4);
          u3 && u3(i4), l2.forEach(function(r5) {
            return (0, r5.resolve)(i4);
          }), l2 = [];
        }
      }, f2()), c4) {
        var d4 = r4.apply(n3, e4);
        return u3 && u3(d4), i3(d4);
      }
      l2.push({
        resolve: i3,
        reject: t2
    ...
    if (!ddFound) {
      if (this.ddExtID === 0) {
        ...
        sdp2.media.forEach((m3) => {
          ...
          (_a2 = m3.ext) === null || _a2 === void 0 ? void 0 : _a2.forEach((ext) => {
            if (ext.value > maxID) {
              maxID = ext.value;
            }
          });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (e3 instanceof ConnectionError) {
          ...
          throw ConnectionError.serverUnreachable("Could not fetch region settings, ".concat(e3 instanceof Error ? "".concat(e3.name, ": ").concat(e3.message) : e3));
        }
      } finally {
        unlock();
      }
      ...
      stats.forEach((v3) => {
        ...
        if (v3.type === "outbound-rtp") {
          const vs = {
            ...
            rid: (_a2 = v3.rid) !== null && _a2 !== void 0 ? _a2 : v3.id,
          ...
          if (r4) {
            vs.jitter = r4.jitter;
            vs.packetsLost = r4.packetsLost;
            vs.roundTripTime = r4.roundTripTime;
          }
          items.push(vs);
        }
      });
      ...
      return function* () {
        ...
        try {
          ...
          if (e3 instanceof ConnectionError) {
            ...
            } else if (e3.reason === ConnectionErrorReason.ServiceNotFound) {
              _this2.log.warn("Initial connection failed: ".concat(e3.message, " – Retrying"));
  ...
  waitForPCReconnected() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        this.pcState = PCState.Disconnected;
        throw ConnectionError.internal("could not establish PC connection, ".concat(e3.message));
      }
    });
  }
  /** @internal */
    ...
    this.startAudio = () => __awaiter(this, void 0, void 0, function* () {
      ...
      this.remoteParticipants.forEach((p2) => {
        p2.audioTrackPublications.forEach((t) => {
          if (t.track) {
            t.track.attachedElements.forEach((e3) => {
              elements.push(e3);
            });
          }
        });
...
function _defineProperty(e3, r4, t) {
...
function _toPrimitive(t, r4) {
  ...
  return ("string" === r4 ? String : Number)(t);
}
...
function s() {
  return s = Object.assign ? Object.assign.bind() : function(e3) {
    for (var t = 1; t < arguments.length; t++) {
      var n2 = arguments[t];
      for (var o3 in n2) ({}).hasOwnProperty.call(n2, o3) && (e3[o3] = n2[o3]);
    }
    return e3;
...
var r2 = class {
  static getFullOptions(e3) {
    return s({ clientTools: {}, onConnect: () => {
    }, onDebug: () => {
    }, onDisconnect: () => {
    }, onError: () => {
    }, onMessage: () => {
  ...
  constructor(e3, t) {
    var n2 = this;
    this.options = void 0, this.connection = void 0, this.lastInterruptTimestamp = 0, this.mode = "listening", this.status = "connecting", this.volume = 1, this.currentEventId = 1, this.lastFeedbackEventId = 0, this.canSendFeedback = false, this.endSessionWithDetails = async function(e4) {
      "connected" !== n2.status && "connecting" !== n2.status || (n2.updateStatus("disconnecting"), await n2.handleEndSession(), n2.updateStatus("disconnected"), n2.options.onDisconnect && n2.options.onDisconnect(e4));
      ...
      switch (e4.type) {
        ...
        case "client_tool_call":
          try {
            await n2.handleClientToolCall(e4);
          } catch (t2) {
            n2.onError(`Unexpected error in client tool call handling: ${t2 instanceof Error ? t2.message : String(t2)}`, { clientToolName: e4.client_tool_call.tool_name, toolCallId: e4.client_tool_call.tool_call_id });
          }
          return;
        case "audio":
          return void n2.handleAudio(e4);
        case "vad_score":
          return void n2.handleVadScore(e4);
        case "ping":
          return void n2.connection.sendMessage({ type: "pong", event_id: e4.ping_event.event_id });
        case "mcp_tool_call":
          return void n2.handleMCPToolCall(e4);
        case "mcp_connection_status":
          return void n2.handleMCPConnectionStatus(e4);
        case "agent_tool_request":
          return void n2.handleAgentToolRequest(e4);
        case "agent_tool_response":
          return void n2.handleAgentToolResponse(e4);
        case "conversation_initiation_metadata":
          return void n2.handleConversationMetadata(e4);
        case "asr_initiation_metadata":
          return void n2.handleAsrInitiationMetadata(e4);
        case "agent_chat_response_part":
          return void n2.handleAgentChatResponsePart(e4);
        case "error":
          return void n2.handleErrorEvent(e4);
        default:
          return void (n2.options.onDebug && n2.options.onDebug(e4));
      }
    }, this.setVolume = ({ volume: e4 }) => {
      this.volume = e4;
    }, this.options = e3, this.connection = t, this.options.onConnect && this.options.onConnect({ conversationId: t.conversationId }), this.connection.onMessage(this.onMessage), this.connection.onDisconnect(this.endSessionWithDetails), this.connection.onModeChange((e4) => this.updateMode(e4)), this.updateStatus("connected");
  }
  endSession() {
  ...
  updateMode(e3) {
    e3 !== this.mode && (this.mode = e3, this.options.onModeChange && this.options.onModeChange({ mode: e3 }));
  }
  updateStatus(e3) {
    e3 !== this.status && (this.status = e3, this.options.onStatusChange && this.options.onStatusChange({ status: e3 }));
  }
  updateCanSendFeedback() {
    const e3 = this.currentEventId !== this.lastFeedbackEventId;
    this.canSendFeedback !== e3 && (this.canSendFeedback = e3, this.options.onCanSendFeedbackChange && this.options.onCanSendFeedbackChange({ canSendFeedback: e3 }));
  }
  handleInterruption(e3) {
    e3.interruption_event && (this.lastInterruptTimestamp = e3.interruption_event.event_id, this.options.onInterruption && this.options.onInterruption({ event_id: e3.interruption_event.event_id }));
  }
  handleAgentResponse(e3) {
    this.options.onMessage && this.options.onMessage({ source: "ai", role: "agent", message: e3.agent_response_event.agent_response });
  }
  handleUserTranscript(e3) {
    this.options.onMessage && this.options.onMessage({ source: "user", role: "user", message: e3.user_transcription_event.user_transcript });
  }
  handleTentativeAgentResponse(e3) {
    this.options.onDebug && this.options.onDebug({ type: "tentative_agent_response", response: e3.tentative_agent_response_internal_event.tentative_agent_response });
  }
  handleVadScore(e3) {
    this.options.onVadScore && this.options.onVadScore({ vadScore: e3.vad_score_event.vad_score });
  }
  async handleClientToolCall(e3) {
    if (Object.prototype.hasOwnProperty.call(this.options.clientTools, e3.client_tool_call.tool_name)) try {
      var t;
      const n2 = null != (t = await this.options.clientTools[e3.client_tool_call.tool_name](e3.client_tool_call.parameters)) ? t : "Client tool execution successful.", o3 = "object" == typeof n2 ? JSON.stringify(n2) : String(n2);
      this.connection.sendMessage({ type: "client_tool_result", tool_call_id: e3.client_tool_call.tool_call_id, result: o3, is_error: false });
    } catch (t2) {
      this.onError(`Client tool execution failed with following error: ${null == t2 ? void 0 : t2.message}`, { clientToolName: e3.client_tool_call.tool_name }), this.connection.sendMessage({ type: "client_tool_result", tool_call_id: e3.client_tool_call.tool_call_id, result: `Client tool execution failed: ${null == t2 ? void 0 : t2.message}`, is_error: true });
    }
    else {
  ...
  handleMCPToolCall(e3) {
    this.options.onMCPToolCall && this.options.onMCPToolCall(e3.mcp_tool_call);
  }
  handleMCPConnectionStatus(e3) {
    this.options.onMCPConnectionStatus && this.options.onMCPConnectionStatus(e3.mcp_connection_status);
  }
  handleAgentToolRequest(e3) {
    this.options.onAgentToolRequest && this.options.onAgentToolRequest(e3.agent_tool_request);
  }
  handleAgentToolResponse(e3) {
    "end_call" === e3.agent_tool_response.tool_name && this.endSessionWithDetails({ reason: "agent", context: new CloseEvent("end_call", { reason: "Agent ended the call" }) }), this.options.onAgentToolResponse && this.options.onAgentToolResponse(e3.agent_tool_response);
  }
  handleConversationMetadata(e3) {
    this.options.onConversationMetadata && this.options.onConversationMetadata(e3.conversation_initiation_metadata_event);
  }
  handleAsrInitiationMetadata(e3) {
    this.options.onAsrInitiationMetadata && this.options.onAsrInitiationMetadata(e3.asr_initiation_metadata_event);
  }
  handleAgentChatResponsePart(e3) {
    this.options.onAgentChatResponsePart && this.options.onAgentChatResponsePart(e3.text_response_part);
  }
  handleErrorEvent(e3) {
    const t = e3.error_event.error_type, n2 = e3.error_event.message || e3.error_event.reason || "Unknown error";
    "max_duration_exceeded" !== t ? this.onError(`Server error: ${n2}`, { errorType: t, code: e3.error_event.code, debugMessage: e3.error_event.debug_message, details: e3.error_event.details }) : this.endSessionWithDetails({ reason: "error", message: n2, context: new Event("max_duration_exceeded") });
  }
  onError(e3, t) {
    console.error(e3, t), this.options.onError && this.options.onError(e3, t);
  }
  getId() {
  ...
  setMicMuted(e3) {
    this.connection.setMicMuted(e3);
  }
  ...
  sendMCPToolApprovalResult(e3, t) {
    this.connection.sendMessage({ type: "mcp_tool_approval_result", tool_call_id: e3, is_approved: t });
  }
};
var c = class {
  constructor(e3 = {}) {
    this.queue = [], this.disconnectionDetails = null, this.onDisconnectCallback = null, this.onMessageCallback = null, this.onModeChangeCallback = null, this.onDebug = void 0, this.onDebug = e3.onDebug;
  }
  debug(e3) {
  ...
  onModeChange(e3) {
    this.onModeChangeCallback = e3;
  }
  updateMode(e3) {
    var t;
    null == (t = this.onModeChangeCallback) || t.call(this, e3);
  }
  disconnect(e3) {
    var t;
    this.disconnectionDetails || (this.disconnectionDetails = e3, null == (t = this.onDisconnectCallback) || t.call(this, e3));
  }
  handleMessage(e3) {
...
function l(e3) {
  const [t, n2] = e3.split("_");
  if (!["pcm", "ulaw"].includes(t)) throw new Error(`Invalid format: ${e3}`);
  const o3 = Number.parseInt(n2);
  if (Number.isNaN(o3)) throw new Error(`Invalid sample rate: ${n2}`);
  return { format: t, sampleRate: o3 };
}
var u = "0.13.0";
function d(e3) {
  return !!e3.type;
...
function p(e3) {
  var t;
  const n2 = { type: h2 };
  var o3, a2, s3, i2, r4, c3, l2, u3;
  return e3.overrides && (n2.conversation_config_override = { agent: { prompt: null == (o3 = e3.overrides.agent) ? void 0 : o3.prompt, first_message: null == (a2 = e3.overrides.agent) ? void 0 : a2.firstMessage, language: null == (s3 = e3.overrides.agent) ? void 0 : s3.language }, tts: { voice_id: null == (i2 = e3.overrides.tts) ? void 0 : i2.voiceId, speed: null == (r4 = e3.overrides.tts) ? void 0 : r4.speed, stability: null == (c3 = e3.overrides.tts) ? void 0 : c3.stability, similarity_boost: null == (l2 = e3.overrides.tts) ? void 0 : l2.similarityBoost }, conversation: { text_only: null == (u3 = e3.overrides.conversation) ? void 0 : u3.textOnly } }), e3.customLlmExtraBody && (n2.custom_llm_extra_body = e3.customLlmExtraBody), e3.dynamicVariables && (n2.dynamic_variables = e3.dynamicVariables), e3.userId && (n2.user_id = e3.userId), null != (t = e3.overrides) && t.client && (n2.source_info = { source: e3.overrides.client.source, version: e3.overrides.client.version }), n2;
}
var m = class extends Error {
  constructor(e3, t) {
    super(e3), this.closeCode = void 0, this.closeReason = void 0, this.name = "SessionConnectionError", this.closeCode = null == t ? void 0 : t.closeCode, this.closeReason = null == t ? void 0 : t.closeReason;
  }
};
var v = class _v extends c {
  constructor(e3, t, n2, o3) {
    super(), this.socket = void 0, this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.socket = e3, this.conversationId = t, this.inputFormat = n2, this.outputFormat = o3, this.socket.addEventListener("error", (e4) => {
      ...
      this.disconnect(1e3 === e4.code ? { reason: "agent", context: e4, closeCode: e4.code, closeReason: e4.reason || void 0 } : { reason: "error", message: e4.reason || "The connection was closed by the server.", context: e4, closeCode: e4.code, closeReason: e4.reason || void 0 });
    }), this.socket.addEventListener("message", (e4) => {
      try {
        const t2 = JSON.parse(e4.data);
        if (!d(t2)) return void this.debug({ type: "invalid_event", message: "Received invalid socket event", data: e4.data });
        this.handleMessage(t2);
      } catch (t2) {
        this.debug({ type: "parsing_error", message: "Failed to parse socket message", error: t2 instanceof Error ? t2.message : String(t2), data: e4.data });
      }
    });
  }
  static async create(e3) {
    ...
    try {
      var n2, o3, a2;
      const s4 = null != (n2 = e3.origin) ? n2 : "wss://api.elevenlabs.io";
      let i2;
      const r4 = (null == (o3 = e3.overrides) || null == (o3 = o3.client) ? void 0 : o3.version) || u, c3 = (null == (a2 = e3.overrides) || null == (a2 = a2.client) ? void 0 : a2.source) || "js_sdk";
      if (e3.signedUrl) {
        const t2 = e3.signedUrl.includes("?") ? "&" : "?";
        i2 = `${e3.signedUrl}${t2}source=${c3}&version=${r4}`;
      } else i2 = `${s4}/v1/convai/conversation?agent_id=${e3.agentId}&source=${c3}&version=${r4}`;
      const h3 = ["convai"];
      e3.authorization && h3.push(`bearer.${e3.authorization}`), t = new WebSocket(i2, h3);
      const g2 = await new Promise((n3, o4) => {
        t.addEventListener("open", () => {
          var n4;
          const o5 = p(e3);
          null == (n4 = t) || n4.send(JSON.stringify(o5));
        }, { once: true }), t.addEventListener("error", (e4) => {
          setTimeout(() => o4(new m("The connection was closed due to a socket error.")), 0);
        }), t.addEventListener("close", (e4) => {
          o4(new m(e4.reason || (1e3 === e4.code ? "Connection closed normally before session could be established." : "Connection closed unexpectedly before session could be established."), { closeCode: e4.code, closeReason: e4.reason || void 0 }));
        }), t.addEventListener("message", (e4) => {
          const t2 = JSON.parse(e4.data);
          d(t2) && ("conversation_initiation_metadata" === t2.type ? n3(t2.conversation_initiation_metadata_event) : console.warn("First received message is not conversation metadata."));
        }, { once: true });
      }), { conversation_id: f2, agent_output_audio_format: _3, user_input_audio_format: w2 } = g2, b2 = l(null != w2 ? w2 : "pcm_16000"), S2 = l(_3);
      return new _v(t, f2, b2, S2);
    } catch (e4) {
      var s3;
      throw null == (s3 = t) || s3.close(), e4;
    }
  }
  close() {
  ...
  async setMicMuted(e3) {
    console.warn(`WebSocket connection setMicMuted called with ${e3}, but this is handled by VoiceConversation`);
  }
};
function g(e3) {
  const t = new Uint8Array(e3);
  return window.btoa(String.fromCharCode(...t));
}
function f(e3) {
  const t = window.atob(e3), n2 = t.length, o3 = new Uint8Array(n2);
  for (let e4 = 0; e4 < n2; e4++) o3[e4] = t.charCodeAt(e4);
  return o3.buffer;
}
...
function w(e3, t) {
  return async (n2, o3) => {
    ...
    if (o3) try {
      return await n2.addModule(o3), void _2.set(e3, o3);
    } catch (t2) {
      throw new Error(`Failed to load the ${e3} worklet module from path: ${o3}. Error: ${t2}`);
    }
    const s3 = new Blob([t], { type: "application/javascript" }), i2 = URL.createObjectURL(s3);
    try {
      return await n2.addModule(i2), void _2.set(e3, i2);
    } catch (e4) {
      URL.revokeObjectURL(i2);
    }
    try {
      const o4 = `data:application/javascript;base64,${btoa(t)}`;
      await n2.addModule(o4), _2.set(e3, o4);
    } catch (t2) {
      throw new Error(`Failed to load the ${e3} worklet module. Make sure the browser supports AudioWorklets. If you are using a strict CSP, you may need to self-host the worklet files.`);
    }
  };
}
var b = w("rawAudioProcessor", `/*
...
`);
var S = class _S extends c {
  constructor(e3, t, n2, o3, a2 = {}) {
    super(a2), this.conversationId = void 0, this.inputFormat = void 0, this.outputFormat = void 0, this.room = void 0, this.isConnected = false, this.audioEventId = 1, this.audioCaptureContext = null, this.audioElements = [], this.outputDeviceId = null, this.outputAnalyser = null, this.outputFrequencyData = null, this.room = e3, this.conversationId = t, this.inputFormat = n2, this.outputFormat = o3, this.setupRoomEventListeners();
  }
  static async create(n2) {
    let o3;
    if ("conversationToken" in n2 && n2.conversationToken) o3 = n2.conversationToken;
    else {
      if (!("agentId" in n2) || !n2.agentId) throw new Error("Either conversationToken or agentId is required for WebRTC connection");
      try {
        var a2, s3, i2;
        const e3 = (null == (a2 = n2.overrides) || null == (a2 = a2.client) ? void 0 : a2.version) || u, t = (null == (s3 = n2.overrides) || null == (s3 = s3.client) ? void 0 : s3.source) || "js_sdk", c4 = `${r4 = null != (i2 = n2.origin) ? i2 : "https://api.elevenlabs.io", r4.replace(/^wss:\/\//, "https://")}/v1/convai/conversation/token?agent_id=${n2.agentId}&source=${t}&version=${e3}`, l2 = await fetch(c4);
        if (!l2.ok) throw new Error(`ElevenLabs API returned ${l2.status} ${l2.statusText}`);
        if (o3 = (await l2.json()).token, !o3) throw new Error("No conversation token received from API");
      } catch (e3) {
        let t = e3 instanceof Error ? e3.message : String(e3);
        throw e3 instanceof Error && e3.message.includes("401") && (t = "Your agent has authentication enabled, but no signed URL or conversation token was provided."), new Error(`Failed to fetch conversation token for agent ${n2.agentId}: ${t}`);
      }
    }
    var r4;
    const c3 = new Room();
    try {
      const e3 = `room_${Date.now()}`, a3 = l("pcm_48000"), s4 = l("pcm_48000"), i3 = new _S(c3, e3, a3, s4, n2), r5 = n2.livekitUrl || "wss://livekit.rtc.elevenlabs.io";
      var d3;
      await c3.connect(r5, o3), await new Promise((e4) => {
        if (i3.isConnected) e4();
        else {
          const n3 = () => {
            c3.off(RoomEvent.Connected, n3), e4();
          };
          c3.on(RoomEvent.Connected, n3);
        }
      }), c3.name && (i3.conversationId = (null == (d3 = c3.name.match(/(conv_[a-zA-Z0-9]+)/)) ? void 0 : d3[0]) || c3.name), n2.textOnly || await c3.localParticipant.setMicrophoneEnabled(true);
      const u3 = p(n2);
      return i3.debug({ type: h2, message: u3 }), await i3.sendMessage(u3), i3;
    } catch (e3) {
      throw await c3.disconnect(), e3;
    }
  }
  setupRoomEventListeners() {
    ...
    }), this.room.on(RoomEvent.DataReceived, (e4, t) => {
      try {
        const t2 = JSON.parse(new TextDecoder().decode(e4));
        if ("audio" === t2.type) return;
        d(t2) ? this.handleMessage(t2) : console.warn("Invalid socket event received:", t2);
      } catch (t2) {
        console.warn("Failed to parse incoming data message:", t2), console.warn("Raw payload:", new TextDecoder().decode(e4));
      }
    }), this.room.on(RoomEvent.TrackSubscribed, async function(t, n2, a2) {
      if (t.kind === Track.Kind.Audio && a2.identity.includes("agent")) {
        const n3 = t, o3 = n3.attach();
        if (o3.autoplay = true, o3.controls = false, e3.outputDeviceId && o3.setSinkId) try {
          await o3.setSinkId(e3.outputDeviceId);
        } catch (e4) {
          console.warn("Failed to set output device for new audio element:", e4);
        }
        o3.style.display = "none", document.body.appendChild(o3), e3.audioElements.push(o3), 1 === e3.audioElements.length && (null == e3.onDebug || e3.onDebug({ type: "audio_element_ready" })), await e3.setupAudioCapture(n3);
      }
    }), this.room.on(RoomEvent.ActiveSpeakersChanged, async function(t) {
      e3.updateMode(t.length > 0 && t[0].identity.startsWith("agent") ? "speaking" : "listening");
    }), this.room.on(RoomEvent.ParticipantDisconnected, (e4) => {
      var t;
      null != (t = e4.identity) && t.startsWith("agent") && this.disconnect({ reason: "agent", context: new CloseEvent("close", { reason: "agent disconnected" }) });
    });
  }
  close() {
    if (this.isConnected) {
      try {
        this.room.localParticipant.audioTrackPublications.forEach((e3) => {
          e3.track && e3.track.stop();
        });
      } catch (e3) {
        console.warn("Error stopping local tracks:", e3);
      }
      this.audioCaptureContext && (this.audioCaptureContext.close().catch((e3) => {
        console.warn("Error closing audio capture context:", e3);
      }), this.audioCaptureContext = null), this.audioElements.forEach((e3) => {
  ...
  async sendMessage(e3) {
    if (this.isConnected && this.room.localParticipant) {
      if (!("user_audio_chunk" in e3)) try {
        const t = new TextEncoder().encode(JSON.stringify(e3));
        await this.room.localParticipant.publishData(t, { reliable: true });
      } catch (t) {
        this.debug({ type: "send_message_error", message: { message: e3, error: t } }), console.error("Failed to send message via WebRTC:", t);
      }
  ...
  async setMicMuted(e3) {
    ...
    if (null != t && t.track) try {
      e3 ? await t.track.mute() : await t.track.unmute();
    } catch (t2) {
      await this.room.localParticipant.setMicrophoneEnabled(!e3);
    }
    else await this.room.localParticipant.setMicrophoneEnabled(!e3);
  }
  async setupAudioCapture(e3) {
    try {
      ...
      const n2 = new MediaStream([e3.mediaStreamTrack]), o3 = t.createMediaStreamSource(n2);
      o3.connect(this.outputAnalyser), await b(t.audioWorklet);
      const a2 = new AudioWorkletNode(t, "rawAudioProcessor");
      this.outputAnalyser.connect(a2), a2.port.postMessage({ type: "setFormat", format: this.outputFormat.format, sampleRate: this.outputFormat.sampleRate }), a2.port.onmessage = (e4) => {
        const [t2, n3] = e4.data;
        if (n3 > 0.01) {
          const e5 = g(t2.buffer), n4 = this.audioEventId++;
          this.handleMessage({ type: "audio", audio_event: { audio_base_64: e5, event_id: n4 } });
        }
      }, o3.connect(a2);
    } catch (e4) {
      console.warn("Failed to set up audio capture:", e4);
    }
  }
  setAudioVolume(e3) {
  ...
  async setAudioOutputDevice(e3) {
    ...
    const t = this.audioElements.map(async function(t2) {
      try {
        await t2.setSinkId(e3);
      } catch (e4) {
        throw console.error("Failed to set sink ID for audio element:", e4), e4;
      }
    });
    await Promise.all(t), this.outputDeviceId = e3;
  }
  async setAudioInputDevice(e3) {
    ...
    try {
      ...
      const n2 = { deviceId: { exact: e3 }, echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } }, s3 = await createLocalAudioTrack(n2);
      await this.room.localParticipant.publishTrack(s3, { name: "microphone", source: Track.Source.Microphone });
    } catch (e4) {
      console.error("Failed to change input device:", e4);
      try {
        await this.room.localParticipant.setMicrophoneEnabled(true);
      } catch (e5) {
        console.error("Failed to recover microphone after device switch error:", e5);
      }
      throw e4;
    }
  }
...
async function E(e3 = { default: 0, android: 3e3 }) {
  let t = e3.default;
  var n2;
  if (/android/i.test(navigator.userAgent)) t = null != (n2 = e3.android) ? n2 : t;
  else if (k()) {
    var o3;
    t = null != (o3 = e3.ios) ? o3 : t;
  }
  t > 0 && await new Promise((e4) => setTimeout(e4, t));
}
var C = class _C extends r2 {
  static async startSession(e3) {
    const t = r2.getFullOptions(e3);
    ...
    let n2 = null;
    try {
      return await E(t.connectionDelay), n2 = await y(e3), new _C(t, n2);
    } catch (e4) {
      var o3;
      throw t.onStatusChange && t.onStatusChange({ status: "disconnected" }), null == (o3 = n2) || o3.close(), e4;
    }
  }
};
var R = { echoCancellation: true, noiseSuppression: true, autoGainControl: true, channelCount: { ideal: 1 } };
var M = class _M {
  static async create({ sampleRate: e3, format: t, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: a2, libsampleratePath: i2 }) {
    let r4 = null, c3 = null;
    try {
      const l3 = s({ sampleRate: { ideal: e3 } }, R);
      if (k() && n2) {
        const e4 = (await window.navigator.mediaDevices.enumerateDevices()).find((e5) => "audioinput" === e5.kind && ["airpod", "headphone", "earphone"].find((t2) => e5.label.toLowerCase().includes(t2)));
        e4 && (l3.deviceId = { ideal: e4.deviceId });
      }
      o3 && (l3.deviceId = _M.getDeviceIdConstraint(o3));
      const u4 = navigator.mediaDevices.getSupportedConstraints().sampleRate;
      r4 = new window.AudioContext(u4 ? { sampleRate: e3 } : {});
      const d3 = r4.createAnalyser();
      if (!u4) {
        const e4 = i2 || "https://cdn.jsdelivr.net/npm/@alexanderolsen/libsamplerate-js@2.1.2/dist/libsamplerate.worklet.js";
        await r4.audioWorklet.addModule(e4);
      }
      await b(r4.audioWorklet, null == a2 ? void 0 : a2.rawAudioProcessor);
      const h3 = s({ voiceIsolation: true }, l3);
      c3 = await navigator.mediaDevices.getUserMedia({ audio: h3 });
      const p2 = r4.createMediaStreamSource(c3), m3 = new AudioWorkletNode(r4, "rawAudioProcessor");
      return m3.port.postMessage({ type: "setFormat", format: t, sampleRate: e3 }), p2.connect(d3), d3.connect(m3), await r4.resume(), new _M(r4, d3, m3, c3, p2);
    } catch (e4) {
      var l2, u3;
      throw null == (l2 = c3) || l2.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (u3 = r4) || u3.close(), e4;
    }
  }
  static getDeviceIdConstraint(e3) {
    if (e3) return k() ? { ideal: e3 } : { exact: e3 };
  }
  constructor(e3, t, n2, o3, a2) {
    this.context = void 0, this.analyser = void 0, this.worklet = void 0, this.inputStream = void 0, this.mediaStreamSource = void 0, this.context = e3, this.analyser = t, this.worklet = n2, this.inputStream = o3, this.mediaStreamSource = a2;
  }
  async close() {
  ...
  async setInputDevice(e3) {
    try {
      const t = s({}, R);
      e3 && (t.deviceId = _M.getDeviceIdConstraint(e3));
      const n2 = s({ voiceIsolation: true }, t), o3 = await navigator.mediaDevices.getUserMedia({ audio: n2 });
      this.inputStream.getTracks().forEach((e4) => {
        e4.stop();
      }), this.mediaStreamSource.disconnect(), this.inputStream = o3, this.mediaStreamSource = this.context.createMediaStreamSource(o3), this.mediaStreamSource.connect(this.analyser);
    } catch (e4) {
      throw console.error("Failed to switch input device:", e4), e4;
    }
  }
};
var A = w("audioConcatProcessor", '/*\n * ulaw decoding logic taken from the wavefile library\n * https://github.com/rochars/wavefile/blob/master/lib/codecs/mulaw.js\n * USED BY @elevenlabs/client\n */\n\nconst decodeTable = [0,132,396,924,1980,4092,8316,16764];\n\nfunction decodeSample(muLawSample) {\n  let sign;\n  let exponent;\n  let mantissa;\n  let sample;\n  muLawSample = ~muLawSample;\n  sign = (muLawSample & 0x80);\n  exponent = (muLawSample >> 4) & 0x07;\n  mantissa = muLawSample & 0x0F;\n  sample = decodeTable[exponent] + (mantissa << (exponent+3));\n  if (sign !== 0) sample = -sample;\n\n  return sample;\n}\n\nclass AudioConcatProcessor extends AudioWorkletProcessor {\n  constructor() {\n    super();\n    this.buffers = []; // Initialize an empty buffer\n    this.cursor = 0;\n    this.currentBuffer = null;\n    this.wasInterrupted = false;\n    this.finished = false;\n    \n    this.port.onmessage = ({ data }) => {\n      switch (data.type) {\n        case "setFormat":\n          this.format = data.format;\n          break;\n        case "buffer":\n          this.wasInterrupted = false;\n          this.buffers.push(\n            this.format === "ulaw"\n              ? new Uint8Array(data.buffer)\n              : new Int16Array(data.buffer)\n          );\n          break;\n        case "interrupt":\n          this.wasInterrupted = true;\n          break;\n        case "clearInterrupted":\n          if (this.wasInterrupted) {\n            this.wasInterrupted = false;\n            this.buffers = [];\n            this.currentBuffer = null;\n          }\n      }\n    };\n  }\n  process(_, outputs) {\n    let finished = false;\n    const output = outputs[0][0];\n    for (let i = 0; i < output.length; i++) {\n      if (!this.currentBuffer) {\n        if (this.buffers.length === 0) {\n          finished = true;\n          break;\n        }\n        this.currentBuffer = this.buffers.shift();\n        this.cursor = 0;\n      }\n\n      let value = this.currentBuffer[this.cursor];\n      if (this.format === "ulaw") {\n        value = decodeSample(value);\n      }\n      output[i] = value / 32768;\n      this.cursor++;\n\n      if (this.cursor >= this.currentBuffer.length) {\n        this.currentBuffer = null;\n      }\n    }\n\n    if (this.finished !== finished) {\n      this.finished = finished;\n      this.port.postMessage({ type: "process", finished });\n    }\n\n    return true; // Continue processing\n  }\n}\n\nregisterProcessor("audioConcatProcessor", AudioConcatProcessor);\n');
var I = class _I {
  static async create({ sampleRate: e3, format: t, outputDeviceId: n2, workletPaths: o3 }) {
    let a2 = null, s3 = null;
    try {
      a2 = new AudioContext({ sampleRate: e3 });
      const i3 = a2.createAnalyser(), r5 = a2.createGain();
      s3 = new Audio(), s3.src = "", s3.load(), s3.autoplay = true, s3.style.display = "none", document.body.appendChild(s3);
      const c3 = a2.createMediaStreamDestination();
      s3.srcObject = c3.stream, r5.connect(i3), i3.connect(c3), await A(a2.audioWorklet, null == o3 ? void 0 : o3.audioConcatProcessor);
      const l2 = new AudioWorkletNode(a2, "audioConcatProcessor");
      return l2.port.postMessage({ type: "setFormat", format: t }), l2.connect(r5), await a2.resume(), n2 && s3.setSinkId && await s3.setSinkId(n2), new _I(a2, i3, r5, l2, s3);
    } catch (e4) {
      var i2, r4;
      throw null != (i2 = s3) && i2.parentNode && s3.parentNode.removeChild(s3), null == (r4 = s3) || r4.pause(), a2 && "closed" !== a2.state && await a2.close(), e4;
    }
  }
  constructor(e3, t, n2, o3, a2) {
    this.context = void 0, this.analyser = void 0, this.gain = void 0, this.worklet = void 0, this.audioElement = void 0, this.context = e3, this.analyser = t, this.gain = n2, this.worklet = o3, this.audioElement = a2;
  }
  async setOutputDevice(e3) {
    if (!("setSinkId" in HTMLAudioElement.prototype)) throw new Error("setSinkId is not supported in this browser");
    await this.audioElement.setSinkId(e3 || "");
  }
  async close() {
...
var D = class _D extends r2 {
  ...
  static async startSession(e3) {
    var t;
    const n2 = r2.getFullOptions(e3);
    n2.onStatusChange && n2.onStatusChange({ status: "connecting" }), n2.onCanSendFeedbackChange && n2.onCanSendFeedbackChange({ canSendFeedback: false });
    let o3 = null, a2 = null, i2 = null, c3 = null, l2 = null;
    (null == (t = e3.useWakeLock) || t) && (l2 = await _D.requestWakeLock());
    try {
      var u3;
      return c3 = await navigator.mediaDevices.getUserMedia({ audio: true }), await E(n2.connectionDelay), a2 = await y(e3), [o3, i2] = await Promise.all([M.create(s({}, a2.inputFormat, { preferHeadphonesForIosDevices: e3.preferHeadphonesForIosDevices, inputDeviceId: e3.inputDeviceId, workletPaths: e3.workletPaths, libsampleratePath: e3.libsampleratePath })), I.create(s({}, a2.outputFormat, { outputDeviceId: e3.outputDeviceId, workletPaths: e3.workletPaths }))]), null == (u3 = c3) || u3.getTracks().forEach((e4) => {
        e4.stop();
      }), c3 = null, new _D(n2, a2, o3, i2, l2);
    } catch (e4) {
      var d3, h3, p2, m3;
      n2.onStatusChange && n2.onStatusChange({ status: "disconnected" }), null == (d3 = c3) || d3.getTracks().forEach((e5) => {
        e5.stop();
      }), null == (h3 = a2) || h3.close(), await (null == (p2 = o3) ? void 0 : p2.close()), await (null == (m3 = i2) ? void 0 : m3.close());
      try {
        var v3;
        await (null == (v3 = l2) ? void 0 : v3.release()), l2 = null;
      } catch (e5) {
      }
      throw e4;
    }
  ...
  constructor(e3, t, n2, o3, a2) {
    super(e3, t), this.input = void 0, this.output = void 0, this.wakeLock = void 0, this.inputFrequencyData = void 0, this.outputFrequencyData = void 0, this.visibilityChangeHandler = null, this.onInputWorkletMessage = (e4) => {
      "connected" === this.status && this.connection.sendMessage({ user_audio_chunk: g(e4.data[0].buffer) });
      ...
      this.output.gain.gain.cancelScheduledValues(this.output.context.currentTime), this.output.gain.gain.value = this.volume, this.output.worklet.port.postMessage({ type: "clearInterrupted" }), this.output.worklet.port.postMessage({ type: "buffer", buffer: f(e4) });
    }, this.fadeOutAudio = () => {
      ...
      let t2 = 0;
      for (let n3 = 0; n3 < e4.length; n3++) t2 += e4[n3] / 255;
      return t2 /= e4.length, t2 < 0 ? 0 : t2 > 1 ? 1 : t2;
    }, this.setVolume = ({ volume: e4 }) => {
      const t2 = Number.isFinite(e4) ? Math.min(1, Math.max(0, e4)) : 1;
      this.volume = t2, this.connection instanceof S ? this.connection.setAudioVolume(t2) : this.output.gain.gain.value = t2;
    }, this.input = n2, this.output = o3, this.wakeLock = a2, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.output.worklet.port.onmessage = this.onOutputWorkletMessage, a2 && (this.visibilityChangeHandler = () => {
      var e4;
      "visible" === document.visibilityState && null != (e4 = this.wakeLock) && e4.released && _D.requestWakeLock().then((e5) => {
        this.wakeLock = e5;
      });
  ...
  handleAudio(e3) {
    var t, n2;
    super.handleAudio(e3), e3.audio_event.alignment && this.options.onAudioAlignment && this.options.onAudioAlignment(e3.audio_event.alignment), this.lastInterruptTimestamp <= e3.audio_event.event_id && (e3.audio_event.audio_base_64 && (null == (t = (n2 = this.options).onAudio) || t.call(n2, e3.audio_event.audio_base_64), this.connection instanceof S || this.addAudioBase64Chunk(e3.audio_event.audio_base_64)), this.currentEventId = e3.audio_event.event_id, this.updateCanSendFeedback(), this.updateMode("speaking"));
  }
  setMicMuted(e3) {
    this.connection instanceof S ? this.connection.setMicMuted(e3) : this.input.setMuted(e3);
  }
  getInputByteFrequencyData() {
  ...
  getOutputByteFrequencyData() {
    return this.connection instanceof S ? this.connection.getOutputByteFrequencyData() || new Uint8Array(1024) : (null != this.outputFrequencyData || (this.outputFrequencyData = new Uint8Array(this.output.analyser.frequencyBinCount)), this.output.analyser.getByteFrequencyData(this.outputFrequencyData), this.outputFrequencyData);
  }
  getInputVolume() {
  ...
  async changeInputDevice({ sampleRate: e3, format: t, preferHeadphonesForIosDevices: n2, inputDeviceId: o3 }) {
    try {
      if (this.connection instanceof v) try {
        return await this.input.setInputDevice(o3), this.input;
      } catch (e4) {
        console.warn("Failed to change device on existing input, recreating:", e4);
      }
      this.connection instanceof S && await this.connection.setAudioInputDevice(o3 || ""), await this.input.close();
      const a2 = await M.create({ sampleRate: null != e3 ? e3 : this.connection.inputFormat.sampleRate, format: null != t ? t : this.connection.inputFormat.format, preferHeadphonesForIosDevices: n2, inputDeviceId: o3, workletPaths: this.options.workletPaths, libsampleratePath: this.options.libsampleratePath });
      return this.input = a2, this.input.worklet.port.onmessage = this.onInputWorkletMessage, this.input;
    } catch (e4) {
      throw console.error("Error changing input device", e4), e4;
    }
  }
  async changeOutputDevice({ sampleRate: e3, format: t, outputDeviceId: n2 }) {
    try {
      if (this.connection instanceof v) try {
        return await this.output.setOutputDevice(n2), this.output;
      } catch (e4) {
        console.warn("Failed to change device on existing output, recreating:", e4);
      }
      this.connection instanceof S && await this.connection.setAudioOutputDevice(n2 || ""), await this.output.close();
      const o3 = await I.create({ sampleRate: null != e3 ? e3 : this.connection.outputFormat.sampleRate, format: null != t ? t : this.connection.outputFormat.format, outputDeviceId: n2, workletPaths: this.options.workletPaths });
      return this.output = o3, this.output;
    } catch (e4) {
      throw console.error("Error changing output device", e4), e4;
    }
  }
};
function T(e3, t, n2 = "https://api.elevenlabs.io") {
  const o3 = {};
  return "boolean" == typeof t ? o3.feedback = t ? "like" : "dislike" : (o3.rating = t.rating, o3.comment = t.comment), fetch(`${n2}/v1/convai/conversations/${e3}/feedback`, { method: "POST", body: JSON.stringify(o3), headers: { "Content-Type": "application/json" } });
}
var F = class {
  constructor() {
  ...
  on(e3, t) {
    this.listeners.has(e3) || this.listeners.set(e3, /* @__PURE__ */ new Set());
    const n2 = this.listeners.get(e3);
    n2 && n2.add(t);
  }
  off(e3, t) {
    const n2 = this.listeners.get(e3);
...
var P;
!function(e3) {
  e3.SESSION_STARTED = "session_started", e3.PARTIAL_TRANSCRIPT = "partial_transcript", e3.COMMITTED_TRANSCRIPT = "committed_transcript", e3.COMMITTED_TRANSCRIPT_WITH_TIMESTAMPS = "committed_transcript_with_timestamps", e3.AUTH_ERROR = "auth_error", e3.ERROR = "error", e3.OPEN = "open", e3.CLOSE = "close", e3.QUOTA_EXCEEDED = "quota_exceeded", e3.COMMIT_THROTTLED = "commit_throttled", e3.TRANSCRIBER_ERROR = "transcriber_error", e3.UNACCEPTED_TERMS = "unaccepted_terms", e3.RATE_LIMITED = "rate_limited", e3.INPUT_ERROR = "input_error", e3.QUEUE_OVERFLOW = "queue_overflow", e3.RESOURCE_EXHAUSTED = "resource_exhausted", e3.SESSION_TIME_LIMIT_EXCEEDED = "session_time_limit_exceeded", e3.CHUNK_SIZE_EXCEEDED = "chunk_size_exceeded", e3.INSUFFICIENT_AUDIO_ACTIVITY = "insufficient_audio_activity";
}(P || (P = {}));
var x = class {
  constructor(e3) {
    this.websocket = null, this.eventEmitter = new F(), this.currentSampleRate = 16e3, this._audioCleanup = void 0, this.currentSampleRate = e3;
  }
  setWebSocket(e3) {
    this.websocket = e3, this.websocket.readyState === WebSocket.OPEN ? this.eventEmitter.emit(P.OPEN) : this.websocket.addEventListener("open", () => {
      this.eventEmitter.emit(P.OPEN);
    }), this.websocket.addEventListener("message", (e4) => {
      try {
        const t = JSON.parse(e4.data);
        ...
        console.error("Failed to parse WebSocket message:", t, e4.data), this.eventEmitter.emit(P.ERROR, new Error(`Failed to parse message: ${t}`));
      }
    }), this.websocket.addEventListener("error", (e4) => {
      console.error("WebSocket error:", e4), this.eventEmitter.emit(P.ERROR, e4);
    }), this.websocket.addEventListener("close", (e4) => {
      if (console.log(`WebSocket closed: code=${e4.code}, reason="${e4.reason}", wasClean=${e4.wasClean}`), !e4.wasClean || 1e3 !== e4.code && 1005 !== e4.code) {
        const t = `WebSocket closed unexpectedly: ${e4.code} - ${e4.reason || "No reason provided"}`;
        console.error(t), this.eventEmitter.emit(P.ERROR, new Error(t));
      }
      this.eventEmitter.emit(P.CLOSE, e4);
    });
  }
  on(e3, t) {
    this.eventEmitter.on(e3, t);
  }
  off(e3, t) {
    this.eventEmitter.off(e3, t);
  }
  send(e3) {
    var t, n2;
    if (!this.websocket || this.websocket.readyState !== WebSocket.OPEN) throw new Error("WebSocket is not connected");
    const o3 = { message_type: "input_audio_chunk", audio_base_64: e3.audioBase64, commit: null != (t = e3.commit) && t, sample_rate: null != (n2 = e3.sampleRate) ? n2 : this.currentSampleRate, previous_text: e3.previousText };
    this.websocket.send(JSON.stringify(o3));
  }
  commit() {
    if (!this.websocket || this.websocket.readyState !== WebSocket.OPEN) throw new Error("WebSocket is not connected");
...
var L;
!function(e3) {
  e3.PCM_8000 = "pcm_8000", e3.PCM_16000 = "pcm_16000", e3.PCM_22050 = "pcm_22050", e3.PCM_24000 = "pcm_24000", e3.PCM_44100 = "pcm_44100", e3.PCM_48000 = "pcm_48000", e3.ULAW_8000 = "ulaw_8000";
}(U || (U = {})), function(e3) {
  e3.MANUAL = "manual", e3.VAD = "vad";
}(L || (L = {}));
var N = class _N {
  static getWebSocketUri(e3 = _N.DEFAULT_BASE_URI) {
    return `${e3}/v1/speech-to-text/realtime`;
  }
  static buildWebSocketUri(e3) {
    const t = _N.getWebSocketUri(e3.baseUri), n2 = new URLSearchParams();
    if (n2.append("model_id", e3.modelId), n2.append("token", e3.token), void 0 !== e3.commitStrategy && n2.append("commit_strategy", e3.commitStrategy), void 0 !== e3.audioFormat && n2.append("audio_format", e3.audioFormat), void 0 !== e3.vadSilenceThresholdSecs) {
      if (e3.vadSilenceThresholdSecs <= 0.3 || e3.vadSilenceThresholdSecs > 3) throw new Error("vadSilenceThresholdSecs must be between 0.3 and 3.0");
      n2.append("vad_silence_threshold_secs", e3.vadSilenceThresholdSecs.toString());
    }
    if (void 0 !== e3.vadThreshold) {
      if (e3.vadThreshold < 0.1 || e3.vadThreshold > 0.9) throw new Error("vadThreshold must be between 0.1 and 0.9");
      n2.append("vad_threshold", e3.vadThreshold.toString());
    }
    if (void 0 !== e3.minSpeechDurationMs) {
      if (e3.minSpeechDurationMs <= 50 || e3.minSpeechDurationMs > 2e3) throw new Error("minSpeechDurationMs must be between 50 and 2000");
      n2.append("min_speech_duration_ms", e3.minSpeechDurationMs.toString());
    }
    if (void 0 !== e3.minSilenceDurationMs) {
      if (e3.minSilenceDurationMs <= 50 || e3.minSilenceDurationMs > 2e3) throw new Error("minSilenceDurationMs must be between 50 and 2000");
      n2.append("min_silence_duration_ms", e3.minSilenceDurationMs.toString());
    }
    void 0 !== e3.languageCode && n2.append("language_code", e3.languageCode), void 0 !== e3.includeTimestamps && n2.append("include_timestamps", e3.includeTimestamps ? "true" : "false");
    const o3 = n2.toString();
    return o3 ? `${t}?${o3}` : t;
  }
  static connect(e3) {
    if (!e3.modelId) throw new Error("modelId is required");
    const t = new x("microphone" in e3 && e3.microphone ? 16e3 : e3.sampleRate), n2 = _N.buildWebSocketUri(e3), o3 = new WebSocket(n2);
    return "microphone" in e3 && e3.microphone && o3.addEventListener("open", () => {
      _N.streamFromMicrophone(e3, t);
    }), t.setWebSocket(o3), t;
  }
  static async streamFromMicrophone(e3, t) {
    const n2 = 16e3;
    try {
      var o3, a2, s3, i2, r4, c3, l2, u3, d3, h3;
      const p2 = await navigator.mediaDevices.getUserMedia({ audio: { deviceId: null == (o3 = e3.microphone) ? void 0 : o3.deviceId, echoCancellation: null == (a2 = null == (s3 = e3.microphone) ? void 0 : s3.echoCancellation) || a2, noiseSuppression: null == (i2 = null == (r4 = e3.microphone) ? void 0 : r4.noiseSuppression) || i2, autoGainControl: null == (c3 = null == (l2 = e3.microphone) ? void 0 : l2.autoGainControl) || c3, channelCount: null != (u3 = null == (d3 = e3.microphone) ? void 0 : d3.channelCount) ? u3 : 1, sampleRate: { ideal: n2 } } }), m3 = null == (h3 = p2.getAudioTracks()[0]) ? void 0 : h3.getSettings(), v3 = null == m3 ? void 0 : m3.sampleRate, g2 = new AudioContext(v3 ? { sampleRate: v3 } : {});
      await O(g2.audioWorklet);
      const f2 = g2.createMediaStreamSource(p2), _3 = new AudioWorkletNode(g2, "scribeAudioProcessor");
      g2.sampleRate !== n2 && _3.port.postMessage({ type: "configure", inputSampleRate: g2.sampleRate, outputSampleRate: n2 }), _3.port.onmessage = (e4) => {
        const { audioData: n3 } = e4.data, o4 = new Uint8Array(n3);
        let a3 = "";
        for (let e5 = 0; e5 < o4.length; e5++) a3 += String.fromCharCode(o4[e5]);
        const s4 = btoa(a3);
        t.send({ audioBase64: s4 });
      }, f2.connect(_3), "suspended" === g2.state && await g2.resume(), t._audioCleanup = () => {
        p2.getTracks().forEach((e4) => {
          e4.stop();
        }), f2.disconnect(), _3.disconnect(), g2.close();
      };
    } catch (e4) {
      throw console.error("Failed to start microphone streaming:", e4), e4;
    }
  }
};
N.DEFAULT_BASE_URI = "wss://api.elevenlabs.io";
var W = class extends r2 {
  static startSession(e3) {
    return e3.textOnly ? C.startSession(e3) : D.startSession(e3);
  }
};
...
function u2() {
  return u2 = Object.assign ? Object.assign.bind() : function(n2) {
    for (var e3 = 1; e3 < arguments.length; e3++) {
      var r4 = arguments[e3];
      for (var o3 in r4) ({}).hasOwnProperty.call(r4, o3) && (n2[o3] = r4[o3]);
    }
    return n2;
  }, u2.apply(null, arguments);
}
function a(i2 = {}) {
  const { onSessionStarted: a2, onPartialTranscript: s3, onCommittedTranscript: c3, onCommittedTranscriptWithTimestamps: d3, onError: v3, onAuthError: m3, onQuotaExceededError: g2, onCommitThrottledError: p2, onTranscriberError: T2, onUnacceptedTermsError: h3, onRateLimitedError: C2, onInputError: S2, onQueueOverflowError: E2, onResourceExhaustedError: M2, onSessionTimeLimitExceededError: I2, onChunkSizeExceededError: D2, onInsufficientAudioActivityError: w2, onConnect: A2, onDisconnect: R2, token: b2, modelId: y2, baseUri: f2, commitStrategy: O2, vadSilenceThresholdSecs: U2, vadThreshold: k2, minSpeechDurationMs: F2, minSilenceDurationMs: _3, languageCode: P2, microphone: x2, audioFormat: N2, sampleRate: V, autoConnect: L2 = false, includeTimestamps: q } = i2, B = (0, import_react.useRef)(null), [H, $] = (0, import_react.useState)("disconnected"), [Q, W2] = (0, import_react.useState)(""), [X, j] = (0, import_react.useState)([]), [z, K] = (0, import_react.useState)(null);
  (0, import_react.useEffect)(() => () => {
    var n2;
    null == (n2 = B.current) || n2.close();
  }, []);
  const Y = (0, import_react.useCallback)(async (n2 = {}) => {
    if (B.current) console.warn("Already connected");
    else try {
      var e3, r4;
      $("connecting"), K(null);
      const o3 = n2.token || b2, i3 = n2.modelId || y2;
      if (!o3) throw new Error("Token is required");
      if (!i3) throw new Error("Model ID is required");
      const u3 = n2.microphone || x2, L3 = n2.audioFormat || N2, H2 = n2.sampleRate || V;
      let Q2;
      const X2 = null != (e3 = null != (r4 = n2.includeTimestamps) ? r4 : q) ? e3 : !(!n2.onCommittedTranscriptWithTimestamps && !d3);
      if (u3) Q2 = N.connect({ token: o3, modelId: i3, baseUri: n2.baseUri || f2, commitStrategy: n2.commitStrategy || O2, vadSilenceThresholdSecs: n2.vadSilenceThresholdSecs || U2, vadThreshold: n2.vadThreshold || k2, minSpeechDurationMs: n2.minSpeechDurationMs || F2, minSilenceDurationMs: n2.minSilenceDurationMs || _3, languageCode: n2.languageCode || P2, microphone: u3, includeTimestamps: X2 });
      else {
        if (!L3 || !H2) throw new Error("Either microphone options or (audioFormat + sampleRate) must be provided");
        Q2 = N.connect({ token: o3, modelId: i3, baseUri: n2.baseUri || f2, commitStrategy: n2.commitStrategy || O2, vadSilenceThresholdSecs: n2.vadSilenceThresholdSecs || U2, vadThreshold: n2.vadThreshold || k2, minSpeechDurationMs: n2.minSpeechDurationMs || F2, minSilenceDurationMs: n2.minSilenceDurationMs || _3, languageCode: n2.languageCode || P2, includeTimestamps: X2, audioFormat: L3, sampleRate: H2 });
      }
      B.current = Q2, Q2.on(P.SESSION_STARTED, () => {
        $("connected"), null == a2 || a2();
      }), Q2.on(P.PARTIAL_TRANSCRIPT, (n3) => {
        const e4 = n3;
        W2(e4.text), $("transcribing"), null == s3 || s3(e4);
      }), Q2.on(P.COMMITTED_TRANSCRIPT, (n3) => {
        const e4 = n3, r5 = { id: `${Date.now()}-${Math.random()}`, text: e4.text, timestamp: Date.now(), isFinal: true };
        j((n4) => [...n4, r5]), W2(""), null == c3 || c3(e4);
      }), Q2.on(P.COMMITTED_TRANSCRIPT_WITH_TIMESTAMPS, (n3) => {
        const e4 = n3, r5 = { id: `${Date.now()}-${Math.random()}`, text: e4.text, timestamp: Date.now(), isFinal: true, words: e4.words };
        j((n4) => [...n4, r5]), W2(""), null == d3 || d3(e4);
      }), Q2.on(P.ERROR, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == v3 || v3(new Error(e4.error));
      }), Q2.on(P.AUTH_ERROR, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == m3 || m3(e4);
      }), Q2.on(P.QUOTA_EXCEEDED, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == g2 || g2(e4);
      }), Q2.on(P.COMMIT_THROTTLED, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == p2 || p2(e4);
      }), Q2.on(P.TRANSCRIBER_ERROR, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == T2 || T2(e4);
      }), Q2.on(P.UNACCEPTED_TERMS, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == h3 || h3(e4);
      }), Q2.on(P.RATE_LIMITED, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == C2 || C2(e4);
      }), Q2.on(P.INPUT_ERROR, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == S2 || S2(e4);
      }), Q2.on(P.QUEUE_OVERFLOW, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == E2 || E2(e4);
      }), Q2.on(P.RESOURCE_EXHAUSTED, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == M2 || M2(e4);
      }), Q2.on(P.SESSION_TIME_LIMIT_EXCEEDED, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == I2 || I2(e4);
      }), Q2.on(P.CHUNK_SIZE_EXCEEDED, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == D2 || D2(e4);
      }), Q2.on(P.INSUFFICIENT_AUDIO_ACTIVITY, (n3) => {
        const e4 = n3;
        K(e4.error), $("error"), null == w2 || w2(e4);
      }), Q2.on(P.OPEN, () => {
        null == A2 || A2();
      }), Q2.on(P.CLOSE, () => {
        $("disconnected"), B.current = null, null == R2 || R2();
      });
    } catch (n3) {
      const e4 = n3 instanceof Error ? n3.message : "Failed to connect";
      throw K(e4), $("error"), n3;
    }
  }, [b2, y2, f2, O2, U2, k2, F2, _3, P2, x2, N2, V, q, a2, s3, c3, d3, v3, m3, g2, p2, T2, h3, C2, S2, E2, M2, I2, D2, w2, A2, R2]), Z = (0, import_react.useCallback)(() => {
    var n2;
    null == (n2 = B.current) || n2.close(), B.current = null, $("disconnected");
  }, []), G = (0, import_react.useCallback)((n2, e3) => {
    if (!B.current) throw new Error("Not connected to Scribe");
    B.current.send(u2({ audioBase64: n2 }, e3));
  }, []), J = (0, import_react.useCallback)(() => {
    if (!B.current) throw new Error("Not connected to Scribe");
    B.current.commit();
  }, []), nn = (0, import_react.useCallback)(() => {
    j([]), W2("");
  }, []), en = (0, import_react.useCallback)(() => B.current, []);
  return (0, import_react.useEffect)(() => {
    L2 && Y();
  }, [L2, Y]), { status: H, isConnected: "connected" === H || "transcribing" === H, isTranscribing: "transcribing" === H, partialTranscript: Q, committedTranscripts: X, error: z, connect: Y, disconnect: Z, sendAudio: G, commit: J, clearTranscripts: nn, getConnection: en };
}
var s2 = ["micMuted", "volume", "serverLocation"];
function c2(n2 = "us") {
  switch (n2) {
    case "eu-residency":
    case "in-residency":
...
function m2(o3 = {}) {
  const { micMuted: t, volume: l2, serverLocation: a2 } = o3, m3 = function(n2, e3) {
    if (null == n2) return {};
    var r4 = {};
    for (var o4 in n2) if ({}.hasOwnProperty.call(n2, o4)) {
      if (-1 !== e3.indexOf(o4)) continue;
      r4[o4] = n2[o4];
    }
    return r4;
  }(o3, s2), g2 = (0, import_react.useRef)(null), p2 = (0, import_react.useRef)(null), T2 = (0, import_react.useRef)(false), [h3, C2] = (0, import_react.useState)("disconnected"), [S2, E2] = (0, import_react.useState)(false), [M2, I2] = (0, import_react.useState)("listening"), D2 = (0, import_react.useRef)(t), w2 = (0, import_react.useRef)(l2);
  return D2.current = t, w2.current = l2, (0, import_react.useEffect)(() => {
    var n2;
    void 0 !== t && (null == g2 || null == (n2 = g2.current) || n2.setMicMuted(t));
  }, [t]), (0, import_react.useEffect)(() => {
    var n2;
    void 0 !== l2 && (null == g2 || null == (n2 = g2.current) || n2.setVolume({ volume: l2 }));
  }, [l2]), (0, import_react.useEffect)(() => () => {
    var n2;
    T2.current = true, p2.current ? p2.current.then((n3) => n3.endSession()) : null == (n2 = g2.current) || n2.endSession();
  }, []), { startSession: async (n2) => {
    var e3;
    if (null != (e3 = g2.current) && e3.isOpen()) return g2.current.getId();
    if (p2.current) return (await p2.current).getId();
    T2.current = false;
    try {
      var r4, o4, t2, l3, s3, h4, S3, M3, A2, R2;
      const e4 = c2((null == n2 ? void 0 : n2.serverLocation) || a2), b2 = d2(e4), y2 = v2(e4);
      if (p2.current = W.startSession(u2({}, null != m3 ? m3 : {}, null != n2 ? n2 : {}, { origin: b2, livekitUrl: (null == n2 ? void 0 : n2.livekitUrl) || (null == m3 ? void 0 : m3.livekitUrl) || y2, overrides: u2({}, null != (r4 = null == m3 ? void 0 : m3.overrides) ? r4 : {}, null != (o4 = null == n2 ? void 0 : n2.overrides) ? o4 : {}, { client: u2({}, null != (t2 = null == m3 || null == (l3 = m3.overrides) ? void 0 : l3.client) ? t2 : {}, null != (s3 = null == n2 || null == (h4 = n2.overrides) ? void 0 : h4.client) ? s3 : {}, { source: (null == n2 || null == (S3 = n2.overrides) || null == (S3 = S3.client) ? void 0 : S3.source) || (null == m3 || null == (M3 = m3.overrides) || null == (M3 = M3.client) ? void 0 : M3.source) || "react_sdk", version: (null == n2 || null == (A2 = n2.overrides) || null == (A2 = A2.client) ? void 0 : A2.version) || (null == m3 || null == (R2 = m3.overrides) || null == (R2 = R2.client) ? void 0 : R2.version) || "0.13.0" }) }), onConnect: (null == n2 ? void 0 : n2.onConnect) || (null == m3 ? void 0 : m3.onConnect), onDisconnect: (null == n2 ? void 0 : n2.onDisconnect) || (null == m3 ? void 0 : m3.onDisconnect), onError: (null == n2 ? void 0 : n2.onError) || (null == m3 ? void 0 : m3.onError), onMessage: (null == n2 ? void 0 : n2.onMessage) || (null == m3 ? void 0 : m3.onMessage), onAudio: (null == n2 ? void 0 : n2.onAudio) || (null == m3 ? void 0 : m3.onAudio), onDebug: (null == n2 ? void 0 : n2.onDebug) || (null == m3 ? void 0 : m3.onDebug), onUnhandledClientToolCall: (null == n2 ? void 0 : n2.onUnhandledClientToolCall) || (null == m3 ? void 0 : m3.onUnhandledClientToolCall), onVadScore: (null == n2 ? void 0 : n2.onVadScore) || (null == m3 ? void 0 : m3.onVadScore), onInterruption: (null == n2 ? void 0 : n2.onInterruption) || (null == m3 ? void 0 : m3.onInterruption), onAgentToolRequest: (null == n2 ? void 0 : n2.onAgentToolRequest) || (null == m3 ? void 0 : m3.onAgentToolRequest), onAgentToolResponse: (null == n2 ? void 0 : n2.onAgentToolResponse) || (null == m3 ? void 0 : m3.onAgentToolResponse), onConversationMetadata: (null == n2 ? void 0 : n2.onConversationMetadata) || (null == m3 ? void 0 : m3.onConversationMetadata), onMCPToolCall: (null == n2 ? void 0 : n2.onMCPToolCall) || (null == m3 ? void 0 : m3.onMCPToolCall), onMCPConnectionStatus: (null == n2 ? void 0 : n2.onMCPConnectionStatus) || (null == m3 ? void 0 : m3.onMCPConnectionStatus), onAsrInitiationMetadata: (null == n2 ? void 0 : n2.onAsrInitiationMetadata) || (null == m3 ? void 0 : m3.onAsrInitiationMetadata), onAgentChatResponsePart: (null == n2 ? void 0 : n2.onAgentChatResponsePart) || (null == m3 ? void 0 : m3.onAgentChatResponsePart), onAudioAlignment: (null == n2 ? void 0 : n2.onAudioAlignment) || (null == m3 ? void 0 : m3.onAudioAlignment), onModeChange: ({ mode: e5 }) => {
        var r5;
        I2(e5), null == (r5 = (null == n2 ? void 0 : n2.onModeChange) || (null == m3 ? void 0 : m3.onModeChange)) || r5({ mode: e5 });
      }, onStatusChange: ({ status: e5 }) => {
        var r5;
        C2(e5), null == (r5 = (null == n2 ? void 0 : n2.onStatusChange) || (null == m3 ? void 0 : m3.onStatusChange)) || r5({ status: e5 });
      }, onCanSendFeedbackChange: ({ canSendFeedback: e5 }) => {
        var r5;
        E2(e5), null == (r5 = (null == n2 ? void 0 : n2.onCanSendFeedbackChange) || (null == m3 ? void 0 : m3.onCanSendFeedbackChange)) || r5({ canSendFeedback: e5 });
      } })), g2.current = await p2.current, T2.current) throw await g2.current.endSession(), g2.current = null, p2.current = null, new Error("Session cancelled during connection");
      return void 0 !== D2.current && g2.current.setMicMuted(D2.current), void 0 !== w2.current && g2.current.setVolume({ volume: w2.current }), g2.current.getId();
    } finally {
      p2.current = null;
    }
  }, endSession: async () => {
    ...
    if (g2.current = null, n2) {
      const e4 = await n2;
      await e4.endSession();
    } else await (null == e3 ? void 0 : e3.endSession());
  }, setVolume: ({ volume: n2 }) => {
    var e3;
    null == (e3 = g2.current) || e3.setVolume({ volume: n2 });
  }, getInputByteFrequencyData: () => {
    var n2;
    return null == (n2 = g2.current) ? void 0 : n2.getInputByteFrequencyData();
  }, getOutputByteFrequencyData: () => {
    var n2;
    return null == (n2 = g2.current) ? void 0 : n2.getOutputByteFrequencyData();
  }, getInputVolume: () => {
    var n2, e3;
    return null != (n2 = null == (e3 = g2.current) ? void 0 : e3.getInputVolume()) ? n2 : 0;
  }, getOutputVolume: () => {
    var n2, e3;
    return null != (n2 = null == (e3 = g2.current) ? void 0 : e3.getOutputVolume()) ? n2 : 0;
  }, sendFeedback: (n2) => {
    var e3;
    null == (e3 = g2.current) || e3.sendFeedback(n2);
  }, getId: () => {
    var n2;
    return null == (n2 = g2.current) ? void 0 : n2.getId();
  }, sendContextualUpdate: (n2) => {
    var e3;
    null == (e3 = g2.current) || e3.sendContextualUpdate(n2);
  }, sendUserMessage: (n2) => {
    var e3;
    null == (e3 = g2.current) || e3.sendUserMessage(n2);
  }, sendUserActivity: () => {
    var n2;
    null == (n2 = g2.current) || n2.sendUserActivity();
  }, sendMCPToolApprovalResult: (n2, e3) => {
    var r4;
    null == (r4 = g2.current) || r4.sendMCPToolApprovalResult(n2, e3);
  }, changeInputDevice: async (n2) => {
    if (g2.current && "changeInputDevice" in g2.current) return await g2.current.changeInputDevice(n2);
    throw new Error("Device switching is only available for voice conversations");
  }, changeOutputDevice: async (n2) => {
    if (g2.current && "changeOutputDevice" in g2.current) return await g2.current.changeOutputDevice(n2);
    throw new Error("Device switching is only available for voice conversations");
  }, status: h3, canSendFeedback: S2, micMuted: t, isSpeaking: "speaking" === M2 };
}
export {
  U as AudioFormat,
  L as CommitStrategy,
  P as RealtimeEvents,
  v2 as getLivekitUrlForLocation,
  d2 as getOriginForLocation,
  c2 as parseLocation,
  T as postOverallFeedback,
  m2 as useConversation,
  a as useScribe
};
